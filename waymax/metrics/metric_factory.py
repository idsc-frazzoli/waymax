...
_METRICS_REGISTRY: dict[str, abstract_metric.AbstractMetric] = {
    ...
    "gokart_vel_x": gokart_state.GokartStateNormMetric("vel_x"),
    "gokart_vel_y": gokart_state.GokartStateNormMetric("vel_y"),
    "gokart_yaw_rate": gokart_state.GokartStateNormMetric("yaw_rate"),  # example of a custom metric
    "gokart_vel_x_out_range": gokart_state.GokartStateOutRangeMetric("vel_x", -2.0, 6.0),
    "gokart_vel_y_out_range": gokart_state.GokartStateOutRangeMetric("vel_y", -3.0, 3.0),
